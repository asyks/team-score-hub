...
<script type="text/javascript" src="/js/ga-track.js"></script>
 ...
 <script type='text/javascript' src='https://www.google.com/jsapi'></script>
	...
	function drawCharts() {
      ...
      function loadChart1() {
	      var query = new google.visualization.Query("https://docs.google.com/a/modea.com/spreadsheet/tq?range=F1%3AG100&key=0AoTNJnkeM_tBdC1aQ0E2RGlyMmlQaEZUMmhjOElzaUE&gid=11&headers=-1");
	...
	chart1.draw(chartData1.getDataTable(), options);
      ...
      function loadChart2() {
	      var query = new google.visualization.Query("https://docs.google.com/a/modea.com/spreadsheet/tq?range=F3%3AG4&key=0AoTNJnkeM_tBdC1aQ0E2RGlyMmlQaEZUMmhjOElzaUE&gid=12&headers=-1");
	...
	chart2.draw(chartData2.getDataTable(), options);
      ...
      function loadChart3() {
	      var query = new google.visualization.Query("https://docs.google.com/a/modea.com/spreadsheet/tq?range=F1%3AG2&key=0AoTNJnkeM_tBdC1aQ0E2RGlyMmlQaEZUMmhjOElzaUE&gid=12&headers=-1");
	...
	chart3.draw(chartData3.getDataTable(), options);
      ...
      function loadChart4() {
	      var query = new google.visualization.Query("https://docs.google.com/a/modea.com/spreadsheet/tq?range=A3%3AE4&key=0AoTNJnkeM_tBdC1aQ0E2RGlyMmlQaEZUMmhjOElzaUE&gid=12&headers=-1");
	...
	function loadChart5() {
	      var query = new google.visualization.Query("https://docs.google.com/a/modea.com/spreadsheet/tq?range=A1%3AE2&key=0AoTNJnkeM_tBdC1aQ0E2RGlyMmlQaEZUMmhjOElzaUE&gid=12&headers=-1");
